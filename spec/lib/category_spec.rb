...
describe Category do
  PAIRS = [
    ...
    ['Outros rendimentos:Devolucao de impostos'                   , 'Other Income:Tax Refund']              ,
    ['Outros rendimentos:Loterias'                                , 'Other Income:Lotteries']               ,
    ['Outros rendimentos:Mesada'                                  , 'Other Income:Parents Allowence']       ,
    ['Outros rendimentos:Pensao recebida para filho'              , 'Other Income:Child Support']           ,
    ['Outros rendimentos:Presentes recebidos'                     , 'Other Income:Gifts Received']          ,
    ['Outros rendimentos:Principal do emprestimo recebido'        , 'Other Income:Loan Principal Received'] ,
    ['Outros rendimentos:Reembolso'                               , 'Other Income:Refund']                  ,
    ['Outros rendimentos:Seguro desemprego'                       , 'Other Income:Unemployment Comp.']      ,

    ['Remuneracoes e ordenado'                                    , 'Salary']                               ,
    ['Remuneracoes e ordenado:Bonus'                              , 'Salary:Bonus']                         ,
    ['Remuneracoes e ordenado:Comissao'                           , 'Salary:Commission']                    ,
    ['Remuneracoes e ordenado:Contribuicao do empregador'         , 'Salary:Employer Matching']             ,
    ['Remuneracoes e ordenado:Horas extra'                        , 'Salary:Overtime']                      ,
    ['Remuneracoes e ordenado:Pagamento bruto'                    , 'Salary:Paycheck']                      ,
    ['Remuneracoes e ordenado:Pagamento liquido'                  , 'Salary:Paycheck']                      ,

    ['Rendimento de aposentadoria'                                , 'Retirement Income']                    ,
    ['Rendimento de aposentadoria: Contribuicoes ao INSS'         , 'Retirement Income:Social Security']    ,
    ['Rendimento de aposentadoria:Contribuicoes ao INSS'          , 'Retirement Income:Social Security']    ,
    ['Rendimento de aposentadoria:Distribuicoes'                  , 'Retirement Income:IRA Distributions']  ,
    ['Rendimento de aposentadoria:Pensoes e Anuidades'            , 'Retirement Income:Pensions/Annuities'] ,

    ['Rendimento de investimento'                                 , 'Investment']                           ,
    ['Rendimento de investimento:Dividendos'                      , 'Investment:Dividends']                 ,
    ['Rendimento de investimento:Ganhos de capital a curto prazo' , 'Investment:Short-Term Cap. Gains']     ,
    ['Rendimento de investimento:Ganhos de capital a longo prazo' , 'Investment:Long-Term Cap. Gains']      ,
    ['Rendimento de investimento:Juros'                           , 'Investment:Interest Received']         ,
    ['Rendimento de investimento:Juros isentos de imposto'        , 'Investment:Tax-Exempt Interest']       ,
  ]
  PAIRS.each do |pair|
    origin = pair[0]
    target = pair[1]
