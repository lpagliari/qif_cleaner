class Category
  ...
  INSTANCES = {
    ...
    'Outros rendimentos'                                         => Category.new('Other Income'),
    'Outros rendimentos:Devolucao de impostos'                   => Category.new('Other Income:Tax Refund'),
    'Outros rendimentos:Loterias'                                => Category.new('Other Income:Lotteries'),
    'Outros rendimentos:Mesada'                                  => Category.new('Other Income:Parents Allowence'),
    'Outros rendimentos:Pensao recebida para filho'              => Category.new('Other Income:Child Support'),
    'Outros rendimentos:Presentes recebidos'                     => Category.new('Other Income:Gifts Received'),
    'Outros rendimentos:Principal do emprestimo recebido'        => Category.new('Other Income:Loan Principal Received'),
    'Outros rendimentos:Reembolso'                               => Category.new('Other Income:Refund'),
    'Outros rendimentos:Seguro desemprego'                       => Category.new('Other Income:Unemployment Comp.'),

    'Remuneracoes e ordenado'                                    => Category.new('Salary'),
    'Remuneracoes e ordenado:Bonus'                              => Category.new('Salary:Bonus'),
    'Remuneracoes e ordenado:Comissao'                           => Category.new('Salary:Commission'),
    'Remuneracoes e ordenado:Contribuicao do empregador'         => Category.new('Salary:Employer Matching'),
    'Remuneracoes e ordenado:Horas extra'                        => Category.new('Salary:Overtime'),
    'Remuneracoes e ordenado:Pagamento bruto'                    => Category.new('Salary:Paycheck'),
    'Remuneracoes e ordenado:Pagamento liquido'                  => Category.new('Salary:Paycheck'),

    'Rendimento de aposentadoria'                                => Category.new('Retirement Income'),
    'Rendimento de aposentadoria: Contribuicoes ao INSS'         => Category.new('Retirement Income:Social Security'),
    'Rendimento de aposentadoria:Contribuicoes ao INSS'          => Category.new('Retirement Income:Social Security'),
    'Rendimento de aposentadoria:Distribuicoes'                  => Category.new('Retirement Income:IRA Distributions'),
    'Rendimento de aposentadoria:Pensoes e Anuidades'            => Category.new('Retirement Income:Pensions/Annuities'),

    'Rendimento de investimento'                                 => Category.new('Investment'),
    'Rendimento de investimento:Dividendos'                      => Category.new('Investment:Dividends'),
    'Rendimento de investimento:Ganhos de capital a curto prazo' => Category.new('Investment:Short-Term Cap. Gains'),
    'Rendimento de investimento:Ganhos de capital a longo prazo' => Category.new('Investment:Long-Term Cap. Gains'),
    'Rendimento de investimento:Juros'                           => Category.new('Investment:Interest Received'),
    'Rendimento de investimento:Juros isentos de imposto'        => Category.new('Investment:Tax-Exempt Interest'),
  }
end
